...
void welcomeScreen (void) {
	...
	printf ("3. Player 1 and Player 2 gameboards are randomly generated.\n");
	printf ("4. There are 3 types of ships to be placed by longest length to the\n"); 
	printf ("   shortest; [b] Battleship has 4 cells, [r] Cruiser has 3 cells\n");
	printf ("   [d] Destroyer has 2 cells\n");
 ...
 * Definition    : This function allows you to put the 3 types of ship in the
 ...
 *                 on the 9 (4 + 3 + 2) total pegs for each player
 * Pre-condition : n/a
 * Post-condition: n/a
 */
...
Coordinate getTarget (void) {
	...
	printf ("> Enter Target (ex. > 3 4) or \'9 9\' to quit:\n");
	printf ("> ");
